...
const EditWorkout = ({ id }) => {
  ...
  const activity = useSelector(state => state.activities.activities.find(a => a.id === id));
      ...
      <form>
        <div>
          ...
          <select
            ...
            onChange={(e) => setUpdatedActivity({ ...updatedActivity, type: e.target.value })}
          >
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setUpdatedActivity({ ...updatedActivity, duration: e.target.value })}
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => setUpdatedActivity({ ...updatedActivity, distance: e.target.value })}
          />
        </div>
